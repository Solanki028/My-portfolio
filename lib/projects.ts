...
export const projects: Project[] = [
  ...
  },
  {
    ...
    problem: "Creating a high-performance, authoritative online presence for a legal firm that requires instant page load speeds, flawless SEO, and an easy-to-use secure backend for non-technical staff.",
    solution: "Architected a custom MERN-stack solution leveraging Next.js App Router with Server-Side Rendering (SSR) for maximum performance, coupled with a robust Node.js/Express backend featuring JWT authentication and Cloudinary integration.",
